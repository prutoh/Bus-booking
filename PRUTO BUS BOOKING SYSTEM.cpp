...
#include<windows.h>
#include<conio.h>
char ch[20][130]={"Mombasa/Nairobi Express","Kisumu/Nairobi Express","Eldoret/Nairobi Express","Namanga/Nairobi Express","Lodwar/Nairobi Express",
                  "Wajir/Nairobi Express","Mandera/Nairobi Express","Nakuru/Nairobi Express","Bomet/Nairobi Express","Garissa/Nairobi Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
Amount=1400*booking;
printf("\n\t\t\t\tThe Total booking amount is KSH.%.2f",Amount);
itoa(seat1, str1, 10);
...
printf("\n\n");
    printf("======================================================================================================\n");
 printf("\t\t\t\t >>YOUR KSH. 1800 HAS BEEN RETURNED<<\t\t\t\n");
    printf("======================================================================================================\n");
}
    void login()
{
